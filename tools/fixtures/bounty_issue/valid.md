...
Add a lightweight validation script for bounty issue bodies.

Acceptance criteria:
- Create `tools/validate_bounty_issue.py`
- Validate required sections before publishing bounty issues
- Add valid and invalid sample fixtures
